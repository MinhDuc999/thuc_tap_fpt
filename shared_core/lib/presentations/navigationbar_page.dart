        ...
        child: BlocBuilder<NavigationBloc, NavigationState>(
          builder: (context, state) {
            ...
            if (!hasQuery) {
              ...
              suggestedFeatures = searchResults.map((key) => NavigationData.getFeatureByKey(key)).whereType<FeatureModel>().toList();
            }
            return SafeArea(
              child: Scaffold(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      if (state.isSearchViewOpen == true) {
                                        ...
                                        context.read<NavigationBloc>().add(SearchFeature('', allFeatures: allFeatures.map((f) => f.key).toList())
                                        );
                                      }
                                    },
                                    child: Container(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Draggable<String>(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        final emptyIndex =
                                        selectedSlots.indexWhere((e) => e == null);
                                        if (emptyIndex != -1) {
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                hasQuery
                                    ? "Kết quả tìm kiếm (${suggestedFeatures.length})"
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: TextField(
                                        ...
                                        onChanged: (value) {
                                          context.read<NavigationBloc>().add(SearchFeature(value, allFeatures: allFeatures.map((f) => f.key).toList()),
                                          );
                                        },
                                      ),
                                    ),
