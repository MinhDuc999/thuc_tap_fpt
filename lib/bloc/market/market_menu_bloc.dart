...
class MarketMenuBloc extends Bloc<MarketMenuEvent, MarketMenuState> {
  ...
  void _onToggleMarketMenu(
      ToggleMarketMenuEvent event,
      Emitter<MarketMenuState> emit,
      ) {
    emit(_toggleMarketMenuUseCase.execute(state));
  }

  void _onCloseMarketMenu(
      CloseMarketMenuEvent event,
      Emitter<MarketMenuState> emit,
      ) {
