...
Future<void> init() async{
  ...
  getIt.registerLazySingleton<LoadMarketStateUseCase>(() => LoadMarketStateUseCase());
  ...
  getIt.registerLazySingleton<LoadFilterCellStateUseCase>(() => LoadFilterCellStateUseCase());
  ...
  getIt.registerLazySingleton<LoadCatalogStateUseCase>(() => LoadCatalogStateUseCase());
}